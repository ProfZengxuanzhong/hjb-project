...
export default class ProductView {
        ...
        productList.forEach(product => {
            output += `   
                <li class="flex items-center justify-between  w-full py-2 bg-blue-400/ text-white font-medium ss:min-w-[500px] ss:overflow-x-auto ">
                    ...
                    <button type="button" id="${product.id}" class="pdt-dlt-btn p-0 m-0 border-0 bg-transparent cursor-pointer text-red-500 dd:h-6 dd:w-6 ss:h-5 ss:w-5" aria-label="Delete product">
    ...
    toggleProductQty(e) {
        const n = Number.parseInt(this.pdtQty.innerText, 10) || 0;
